...
INPUTS:   FileName, InitialGuess [K, w, P, tp, gamma, ecc], NumOfIterations
OUTPUTS:  Parameters for the best fit RV values, Residual for the fit
===================#
using LsqFit
using PyPlot
include("RVSolver.jl")
...
function RVFit(FileName, InitialGuess, NumOfIterations)
